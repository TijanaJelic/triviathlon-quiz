...
const StartQuiz = () => {
    ...
    const categories = ["Food & Drink", "Arts & Literature", "Film & TV", "Music", "General Knowledge", "Science", "Geography", "Society & Culture", "History", "Sport & Leisure"]
  ...
  return (
    <div className='start-quiz-container'>
        ...
        <div className='wrapper'>
            <div className='categories-container'>
                ...
                <div className='all-categories'>
                    {categories.map((category) => (
                        <button key={category} className={activeCategoryButton === category ? 'category active' : 'category'} onClick={(e) => {
            ...
            <div className='right-wrapper'>
                <div className='num-of-questions-container'>
                    ...
                    <div className='numbers'>
                        {numberOfQuestions.map((num) => (
                            <button key={num} className={activeNumButton === num ? 'number active' : 'number'} onClick={(e) => {
                ...
                <div className='rules-container'>
                    <h2>Rules</h2>
                    <p>You have <b>10 seconds</b> to answer on every question.</p>
        ...
        <Link to='/questions'>
            <button className='play-bttn' disabled={!category.length || !numOfQuestions.length}>Play</button>
        </Link>
    </div>
